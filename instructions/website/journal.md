...
and restrained claims as other technical documentation. They may use a more
personal voice.
...
- Explain why an investigation began and what changed in the team's
  understanding. Keep evidence and its limits close to that account.
- Vary sentence length enough to preserve a natural narrative. Do not apply a
  sentence-length target mechanically.
